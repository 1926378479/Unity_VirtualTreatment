...
public class Selection : MonoBehaviour
{
    ...
    public void OnClick()
    {
        ...
        ResultPanel.Instance.describe.text = GetDescribe(selectionText.text);
    }

    public static string GetDescribe(string diseaseName)
    {
        string tempDis;
        switch (diseaseName)
        {
            case "低血糖":
                tempDis = "低血糖症是一组多种病因引起的以静脉血浆葡萄糖（简称血糖）浓度过低，" +
